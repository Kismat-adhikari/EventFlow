...
import eventflow.controllers.DashboardController;
...
public class Dashboard extends javax.swing.JFrame {
    ...
    private List<EventWithUser> allEvents; // Store all events for filtering
    private JLabel noResultsLabel; // Label to show when no results found
    ...
    public Dashboard(User user) {
        ...
        // Initialize noResultsLabel
        initializeNoResultsLabel();

        searchFilter.setText("🔎 Search");

        searchFilter.addFocusListener(new java.awt.event.FocusAdapter() {
            @Override
            public void focusGained(java.awt.event.FocusEvent evt) {
                if (searchFilter.getText().equals("🔎 Search")) {
    ...
    private void initializeNoResultsLabel() {
        ...
        // Add to eventsPanel (will be positioned properly when shown)
        eventsPanel.add(noResultsLabel);
    }

    /**
     * Add real-time search functionality to searchFilter
     */
    ...
    private void performSearch() {
        if (allEvents == null) {
            return; // No events loaded yet
        }

        String searchQuery = DashboardController.validateSearchQuery(searchFilter.getText());

        // If search query is null (placeholder text), show all events
        if (searchQuery == null) {
            displayEvents(allEvents);
            return;
        }

        // Filter events using the controller method
        List<EventWithUser> filteredEvents = DashboardController.searchEventsByTitle(allEvents, searchQuery);
    ...
    /**
     * Display events and handle no results scenario
     */
    private void displayEvents(List<EventWithUser> events) {
        ...
        if (events == null || events.isEmpty()) {
            ...
            // Hide no results label and show events
            noResultsLabel.setVisible(false);
                ...
                if (event.getCreatorUserId() == user.getId() || user.isAdmin()) {
                    ...
                    deleteButton.addActionListener(actionEvent -> {
                        ...
                        if (confirm == JOptionPane.YES_OPTION) {
                            ...
                            boolean deleteSuccess = eventflow.controllers.DashboardController
                        ...
                        payButton.addActionListener(actionEvent -> {
                            ...
                            if (confirm == JOptionPane.YES_OPTION) {
                                ...
                                if (paymentSuccess) {
                                    ...
                                    eventflow.dao.EventDao.TicketAvailability updatedTicketInfo = eventflow.controllers.DashboardController
                                            .getTicketAvailability(event.getId());

                                    JOptionPane.showMessageDialog(
                                            this,
                                            "Payment successful! You have purchased a ticket for "
                                                    + event.getEventTitle()
                                                    + "\n" +
    ...
    /**
     * Updated loadEvents method to store all events and initialize search
     */
    public void loadEvents(List<EventWithUser> events) {
        this.allEvents = events; // Store all events for filtering
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout
                                                ...
                                                .addGap(51, 51, 51)
                                                .addComponent(searchFilter, javax.swing.GroupLayout.PREFERRED_SIZE, 70,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(47, 47, 47)
